		...
		<div class="subContent">
			<div class="work">
				<ul class="abClear">
					...
					<li><a href="work_view.php?idx=<?php echo $row['idx']?>"><img src="/upfile/<?php echo $row['list_file']?>"><span class="hoverWrap"><span><span><?php echo $row['name_en']?></span><span>프로젝트 보기</span></span></span></a></li>
					<?}?>
