						...
						<div class="cForm">
							<form method="post" action="counseling_proc.php" enctype='multipart/form-data' name="qna_form" onsubmit="return check_form();">
								...
								<div class="terms">
									...
									<div class="agree">
										<input type="checkbox" name="ag" id="ag1" checked="checked"/>
								...
								<div class="formWrap">
									<dl>
										<dt>작성자</dt>
										<dd><input type="text" name="name" placeholder="홍길동" value="<?=$row["name"]?>" /></dd>
									</dl>
									<dl>
										<dt>공개여부</dt>
										<dd>
											<ul class="open">
												<li><input type="radio" name="lock_view" id="op1" checked="checked" value="N" <?if($row["lock_view"]=="N" || $row["lock_view"]==""){?>checked<?}?>/><label for="op1">공개</label></li>
												<li><input type="radio" name="lock_view" id="op2" value="Y"  <?if($row["lock_view"]=="Y"){?>checked<?}?>/><label for="op2">비공개</label></li>
											</ul>
										</dd>
									</dl>
								</div>
								<div class="formWrap">
									<dl>
										<dt>연락처</dt>
										<dd><input type="tel" placeholder="010" title="전화번호 앞 세자리" name="tel1" maxlength="4" value="<?=$tel[0]?>"/><span class="dash">-</span><input type="tel" placeholder="2345" title="전화번호 두번째 네자리" name="tel2" maxlength="4" value="<?=$tel[1]?>"/><span class="dash">-</span><input type="tel" placeholder="6789" title="전화번호 마지막 세자리" name="tel3" maxlength="4" value="<?=$tel[2]?>"/></dd>
									</dl>
									<dl>
										<dt>이메일</dt>
										<dd><input type="text" placeholder="can@kacelab.com" name="email" value="<?=$row["email"]?>" /></dd>
									</dl>
								</div>			
								<dl>
									<dt>제목</dt>
									<dd><input type="text" placeholder="제목을 입력해주세요." name="title" value="<?=$row["title"]?>" /></dd>
								</dl>
								<dl>
									<dt>비밀번호</dt>
								...
								<dl>
									...
									<dd>
										<div class="editArea" >
										<textarea id="content1" name="content"><?=$row["content"]?></textarea></div>
