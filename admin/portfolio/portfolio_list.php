		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				include("../inc/menu.php");
					...
					$query = "select idx FROM TB_portfolio WHERE 1=1 ";  
					...
					$sql = "select * from TB_portfolio where 1=1   order by sort_num asc,idx desc limit $first,$num_per_page";
								...
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<tbody>
											...
											$a_link=" <a href=\"portfolio_write.php?idx=".$row["idx"]."\">";
											?>
											<tr>
												...
												<td class="text-center"><?=$a_link?><?=$title?></a></td>
												<td class="text-center"><?=$reg_id?></td>
...
<script>
		function check_del(){
			...
			if(confirm("삭제시 복구 불가능합니다")==true){
				document.check_form.action="portfolio_proc.php";
