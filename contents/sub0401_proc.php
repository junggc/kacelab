...
if($_POST["mode"]=="modify"){
	...
	if($sel_row["re_content"]){
		?>
		<script>alert("답변이 달린글은 수정이 불가능합니다.");location.href="sub0401.html";</script>
	...
	if(!$result) {
	  ...
	  exit;
		...
		?>
		<script>alert("정상 수정되었습니다.");location.href="sub0401.html";</script>
	...
	if(!$result) {
	  ...
	  exit;
		...
		?>
		<script>alert("정상 등록되었습니다.");location.href="sub0401.html";</script>
