...
$pn_sql = "select
 ...
 where 
  idx IN (
    (select idx as idx from TB_project WHERE idx < '".$_GET['idx']."' order by idx desc limit 1),
    (select idx as idx from TB_project WHERE idx > '".$_GET['idx']."' order by idx desc limit 1)
   )";
	...
	<div class="subContent">
		<div class="work view">
			...
			<div class="btnArea">
				...
				{
				?>
				<a class="btn prev" href="./project_view.php?idx=<?php echo $p_idx;?>">Prev</a>
				<?
				}
				?>
				...
				{
				?>
				<a class="btn next" href="./project_view.php?idx=<?php echo $n_idx;?>">Next</a>
				<?
				}
				?>
				
				<a class="list" href="project_list.php">All Projects</a>
			</div>
		</div>
	</div>
</div>
